...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem, _solved }) => {
	...
	return (
		<div className='bg-dark-layer-1'>
			...
			<div className='flex px-0 py-4 h-[calc(100vh-94px)] overflow-y-auto border-t border-gray-600'>
				<div className='px-5'>
					{/* Problem heading */}
						...
						<div className='mt-4'>
							{problem.examples.map((example, index) => (
								<div key={example.id}>
									...
									{example.img && <Image src={example.img} alt='' className='mt-3 h-auto w-auto' />}
